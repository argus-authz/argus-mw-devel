class mwdevel_argus::pepd::configure (
  ...
  $authn_profile_pip_authn_profile_policy_file = $mwdevel_argus::params::authn_profile_pip_authn_profile_policy_file,
  $authn_profile_pip_trust_anchors_dir = $mwdevel_argus::params::authn_profile_pip_trust_anchors_dir,
  $authn_profile_pip_trust_anchors_policy_file_pattern = $mwdevel_argus::params::authn_profile_pip_trust_anchors_policy_file_pattern,
  $authn_profile_pip_trust_anchors_refresh_interval_in_secs = $mwdevel_argus::params::authn_profile_pip_trust_anchors_refresh_interval_in_secs,
